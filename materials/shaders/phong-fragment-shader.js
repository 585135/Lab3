...
void main() {
    ...
    for (int i = 0; i < NUMBER_OF_LIGHTS; i++) {
        ...
        float lambertian = clamp(dot(lightDirection, normal), 0.001, 1.0); // TODO: implement diffuse term.

        float specular = 0.0;
        if (lambertian > 0.0) {
            // Using reflectDirection and viewDirection we can calculate the specular angle.
            float specAngle = max(dot(reflectDirection, viewDirection), 0.0); // TODO: implement specular term.
